...
class LostsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lost" do
    assert_difference('Lost.count') do
      post losts_url, params: { lost: { content: @lost.content, image: @lost.image, title: @lost.title } }
    end
  ...
  test "should update lost" do
    patch lost_url(@lost), params: { lost: { content: @lost.content, image: @lost.image, title: @lost.title } }
