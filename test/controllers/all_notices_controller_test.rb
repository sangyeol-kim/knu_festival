...
class AllNoticesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create all_notice" do
    assert_difference('AllNotice.count') do
      post all_notices_url, params: { all_notice: { content: @all_notice.content, title: @all_notice.title } }
    end
  ...
  test "should update all_notice" do
    patch all_notice_url(@all_notice), params: { all_notice: { content: @all_notice.content, title: @all_notice.title } }
